...
<div class="col-md-12 textoRemarcado">
<p>
<?php
echo __('Atención! Si no finalizan su pedido no se enviará a su comercial. ');



?></p>
<ul class="menu clearfix finalizarPedido">
...
<div class="col-md-12" style="margin-bottom:25px;">
	...
	<form name="frmPreview" id="frmPreview" method="post" action="<?php echo $urlBase;?>/CashOrders/send">
		<input type="hidden" value="<?=$cash_order;?>" name="cash_order" id="cash_order"> 
		<textarea id="observations" name="observaciones" maxlength="100" style="width:100%"></textarea>
		<input type="submit" name="enviarPedido" id="enviarPedido" class="invisible">
	</form>
</div>
