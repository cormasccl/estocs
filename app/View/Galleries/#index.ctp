...
foreach ($Galleries as $gallery) 
{
    ...
    if ($valor['image_uploaded'] == 1) {
        $image = 'http://www.corma.es/intranet/img/articles/'.$valor['image'];
        $imageThumbs = 'http://www.corma.es/intranet/img/articles/thumbs/'.$valor['image'];
    } else {
...
?>
    ...
    <div class="col-xs-12 col-md-4">
        <div class="row thumbnail">
            <img id="imatge" name="imatge" src="http://www.corma.es/intranet/img/articles/no_foto.jpg" style="height:150px" />
            ...
            <div class="caption" style="text-align:center">
                ...
                <?php
                echo $this->Form->button('<i class="fa fa-floppy-o" aria-hidden="true"></i>', array('class'=>'btn btn-success'));
                echo $this->Form->end();
                ?>
            </div>
        </div>
