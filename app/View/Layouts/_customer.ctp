			...
			<div class="col-md-12 theme-header" itemscope="" itemtype="http://schema.org/WPHeader">
				...
				<?php 
					...
					if (isset($option)) {
						switch ($option) {
							case 'disponible':
								echo $this->element('menu_disponible',array('cataleg' => $catalogue['Catalogue'], 'classificacions' => $catalogueClassification, 'collections'=>$collections, 'filter'=>$filter, 'hay_motoras'=>$hay_motoras, 'hay_novedades'=>$hay_novedades, 'hay_composiciones'=>$hay_composiciones));
								break;
							case 'catalogo':
	                    ...
	                    <div class="clearfix">
							...
							if (!empty($filter)) {
					  		...
					  		<div class="menu-item menu-item-type-custom menu-item-object-custom menu-item-home relative ">
						  		<a href="<?php echo $urlBase;?>/Catalogues/index" class="ioa-button button-small <?php echo $extra;?>" ><?php echo __('Ofertes');?><span class="menu-tail"></span></a>
						  		...
						  		if  ($hay_motoras) {
							  		...
							  		?>
							  		<a href="<?php echo $urlBase;?>/Catalogues/index/motora" class="ioa-button button-small <?php echo $extra;?>" ><?php echo __('Plantes motores');?><span class="spacer"></span><span class="menu-tail"></span></a>
