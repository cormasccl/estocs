...
<link rel="stylesheet" id="cff-font-awesome-css" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.2.0/css/font-awesome.min.css?ver=4.2.0" type="text/css" media="all">
			...
			<div class="col-md-12 theme-header" itemscope="" itemtype="http://schema.org/WPHeader">
				...
				<?php 
					...
					if (isset($option)) {
						switch ($option) {
							case 'disponible':
								echo $this->element('menu_disponible',array('cataleg' => $catalogue['Catalogue'], 'classificacions' => $catalogueClassification, 'collections'=>$collections, 'filter'=>$filter));
								break;
							case 'catalogo':
				...
				<div class="clearfix  auto_align">
					<div class="mutual-content-wrap">
						...
						<div id="container" class="col-md-12">
							<div class="col-md-2">
								<?php
									echo $this->element('menu_left_agent', array('option'=>$option, 'user'=>$user));
								?>
							</div>
