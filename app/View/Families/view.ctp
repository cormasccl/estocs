...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete Family'), array('action' => 'delete', $family['Family']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $family['Family']['id']))); ?> </li>
