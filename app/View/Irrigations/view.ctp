<div class="irrigations view">
<h2><?php echo __('Irrigation'); ?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($irrigation['Irrigation']['id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Created'); ?></dt>
		<dd>
			<?php echo h($irrigation['Irrigation']['created']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Modified'); ?></dt>
		<dd>
			<?php echo h($irrigation['Irrigation']['modified']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Description'); ?></dt>
		<dd>
			<?php echo h($irrigation['Irrigation']['description']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Image'); ?></dt>
		<dd>
			<?php echo h($irrigation['Irrigation']['image']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Code'); ?></dt>
		<dd>
			<?php echo h($irrigation['Irrigation']['code']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Irrigation'), array('action' => 'edit', $irrigation['Irrigation']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Irrigation'), array('action' => 'delete', $irrigation['Irrigation']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $irrigation['Irrigation']['id']))); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($irrigation['Product'])): ?>
	...
	<?php foreach ($irrigation['Product'] as $product): ?>
		<tr>
