...
<p>
	...
	echo "<a href='".$url."/intranet/contacts/confirm/".$hash."' style='".$style."' class='boton' target='blank'>J'ACCEPTE DE CONTINUER A RECEVOIR DES INFORMATIONS</a>";
	?>
...
<?php 
	...
	echo "<a href='".$url."/intranet/contacts/cancel/".$hash."' target='blank' style='".$style."'>Je souhaite annuler l'abonnement</a>";
?>
</div>
