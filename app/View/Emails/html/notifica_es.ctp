...
<p>
	...
	echo "<a href='".$url."/intranet/users_newsletters/confirm/".$hash."' style='".$style."' class='boton' target='blank'>ACEPTO SEGUIR RECIBIENDO INFORMACIÓN</a>";
	?>
...
<?php 
	...
	echo "<a href='".$url."/intranet/users_newsletters/cancel/".$hash."' target='blank' style='".$style."'>Quiero cancelar la subscripción</a>";
?>
</div>
