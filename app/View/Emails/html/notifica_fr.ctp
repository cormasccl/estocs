...
<p>
	...
	echo "<a href='".$url."/intranet/users_newsletters/confirm/".$hash."' style='".$style."' class='boton' target='blank'>J'ACCEPTE DE CONTINUER A RECEVOIR DES INFORMATIONS</a>";
	?>
...
<?php 
	...
	echo "<a href='".$url."/intranet/users_newsletters/cancel/".$hash."' target='blank' style='".$style."'>Je souhaite annuler l'abonnement</a>";
?>
</div>
