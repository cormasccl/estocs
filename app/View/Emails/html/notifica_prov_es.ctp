...
<p>
	...
	echo "<a href='".$url."/intranet/providers/confirm/".$hash."' style='".$style."' class='boton' target='blank'>ACEPTO SEGUIR RECIBIENDO INFORMACIÓN</a>";
	?>
...
<?php 
	...
	echo "<a href='".$url."/intranet/providers/cancel/".$hash."' target='blank' style='".$style."'>Quiero cancelar la subscripción</a>";
?>
</div>
