...
<!--<<div id="container">-->
    ...
    <table  id="container" class='table table-striped table-bordered table-stocks'>
        <thead>
        <?php 
        echo "<th>".__('Artículo')."</th><th class='dreta td_preus'>".__('Precio')."</th><th class='dreta td_unitats'>".__('Estoc disponible')."</th>";
        ?>
    ...
    { 
       ...
       if ($i == 0) {
        ...
        if ($row['Stocks']["available_unities"] == null ) {
            echo "<td class='dreta td_unitats'>0</td>";
        } else {
            echo "<td class='dreta td_unitats'>".number_format($row['Stocks']["available_unities"], 0, ',', '.')."</td>";
        }
...
<table class='table table-striped table-bordered table-stocks'>
    <thead>
        <?php 
        echo "<th>".__('Artículo')."</th><th class='dreta td_unitats'>".__('Estoc disponible')."</th>";
        ?>
